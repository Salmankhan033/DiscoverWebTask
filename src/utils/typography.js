...
export const FONT_FAMILY_REGULAR = "Geologica-Regular";
// export const FONT_FAMILY_Medium = 'Poppins-Medium';
export const FONT_FAMILY_BOLD = "Geologica-Bold";

// FONT WEIGHT
export const FONT_WEIGHT_REGULAR = "400";
export const FONT_WEIGHT_REGULAR_300 = "300";
export const FONT_WEIGHT_REGULAR_500 = "500";
